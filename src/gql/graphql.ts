...
export type StoreConfigQuery = { storeConfig: { store_code: string | null, locale: string | null, base_currency_code: string | null, secure_base_media_url: string | null, cms_home_page: string | null, header_logo_src: string | null, logo_alt: string | null, copyright: string | null, store_name: string | null } | null };
